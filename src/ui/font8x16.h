 ...
 *
 * Simple 8x16 monospace font for display rendering.
 * Contains ASCII characters 32-127 (printable ASCII).
 * Each character is 8 pixels wide and 16 pixels tall.
 * Data is stored as 16 bytes per character, one byte per row,
 * with MSB being the leftmost pixel.
 */
...
/* 96 characters (32-127) x 16 bytes each = 1536 bytes */
static const uint8_t font8x16[96 * 16] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    /* Character 127: DEL (rendered as block) */
